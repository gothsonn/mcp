...
| `install_repository_profiles` | Cria perfis padrao em `.agents/profiles/` dentro do repo. |
| `install_repository_skill` | Instala regras/skills suportadas por repo: `graphify`, `impeccable`, `huashu`. |
...
- Skills suportadas inicialmente: Graphify, Impeccable e Huashu.
...
```text
Use mcp-control para instalar os perfis frontend, backend e product-architecture no repo rafaelfreitas com apply=true.
```
