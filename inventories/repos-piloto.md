...
| `/Users/rafaelpereirafreitas/Sites/rafaelfreitas` | Raiz fullstack com `deploy/`, `frontend/angular.json`, `backend/pom.xml`, Docker no backend | Piloto fullstack pessoal para Graphify e Taste. Ver `inventories/rafaelfreitas.md`. |
